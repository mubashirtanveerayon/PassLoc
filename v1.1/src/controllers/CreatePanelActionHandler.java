...
public class CreatePanelActionHandler implements PanelActionHandler {
    ...
    public void onActionPerformed(ActionEvent e) {
        ...
        if(source== createPanel.nameField){
            createPanel.saveDirectoryField.requestFocus();
            createPanel.saveDirectoryField.setCaretPosition(createPanel.saveDirectoryField.getText().length());
        }else if(source == createPanel.passwordField){
            createPanel.pinField.requestFocus();
            createPanel.pinField.setCaretPosition(createPanel.pinField.getPassword().length);
        }else if(source == createPanel.saveDirectoryField){
            createPanel.passwordField.requestFocus();
            createPanel.passwordField.setCaretPosition(createPanel.passwordField.getPassword().length);
        }else if(source == createPanel.showPassword){
            if(showingPassword){
