...
public class EntryPanelActionHandler implements PanelActionHandler {
    ...
    public void onActionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == entryPanel.tagField){
            ...
            entryPanel.usernameField.setCaretPosition(entryPanel.usernameField.getText().length());
        }else if(e.getSource() == entryPanel.usernameField){
            entryPanel.passwordArea.requestFocus();
            entryPanel.passwordArea.setCaretPosition(entryPanel.passwordArea.getText().length());
            ...
            try{
                ...
                if(JToast.isAvailable())
                    ...
                    JToast.sendToastMessage(JToast.TYPE.SUCCESS,"Data push successful", "Search for the same tag in the view panel to see changes.",JToast.HORIZONTAL_POSITION.RIGHT,JToast.VERTICAL_POSITION.BOTTOM);
